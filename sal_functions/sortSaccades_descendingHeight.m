function listSaccades_height_timestamp = sortSaccades_descendingHeight(listSaccades_height_timestamp)
...
% NOTE. NaN values are returend the same.
    if ~isnan(listSaccades_height_timestamp(1,1))
        [temp, index_temp] = sort(listSaccades_height_timestamp(:,1), 'descend');
